...
export class Pocket {
        ...
        constructor(protected scene: Scene) {
                ...
                this.setupTokens();
                for (let i = 0; i < 4; i++) {
                        this.nowToken.push(this.tokens.pop()!);
                        this.nowTiles.push(this.tiles.pop()!);
                }
                this.nowToken.forEach((wildlife, i) => {
                        ...
                        token.position.x -= 1;
                        token.metadata = { type: "token", wildlife: wildlife };
                ...
                this.nowTiles.forEach((tileInfo, i) => {
                        ...
                        tileMesh.metadata = { type: "tile", tileInfo: tileInfo };
                ...
                this.scene.onPointerDown = (evt, pickInfo) => {
                        ...
                        if (hitToken) {
                                console.log(hitToken.pickedMesh?.metadata);
                        }
                };
        }
