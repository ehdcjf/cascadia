...
export class Board {
	...
	constructor(private scene: Scene, private readonly mediator: Mediator, private readonly gameInfo: GameInfo) {
		...
		main.parent = this.boardAnchor;
		main.position = new Vector3(0, 3, 1);
		main.renderingGroupId = 1;
		main.rotate(new Vector3(1, 0, 0), Tools.ToRadians(350));
		main.setEnabled(true);

		(main.material as PBRMaterial).disableDepthWrite = true;
		(main.material as PBRMaterial).unlit = false;
		(main.material as PBRMaterial).backFaceCulling = false;
