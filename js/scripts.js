...
function checkIfMapLimitReached(direction, newIncrementPosition) {
        if (direction == "horizontal") {
                ...
                if (
                        ...
                        newIncrementPosition >
                        mapStats.centerColumn - mapLimits.left - (horizontalTilesHalfwayAmount + 1)
                ) {
...
function updateMapPosition(moveDirection) {
        if (moveDirection == "horizontal") {
                let newLeftPosNum =
                        mapMoveAmount.tilePos.left * mapMoveAmount.view[currentView].incs.horizontal * (zoomLevel / 10);
                ...
                let newTopPosNum =
                        mapMoveAmount.tilePos.top * mapMoveAmount.view[currentView].incs.vertical * (zoomLevel / 10);
...
$(document).on(touchEvent, ".mapTileContainer.potentialPlacement", function () {
        ...
        $(".tokenTileContainer.chosenTokenTileContainer .tileContainer.lockedIn").parentToAnimate(
                $("#" + targID),
                1000,
        );
...
$(document).on(touchEvent, ".mapTileContainer.potentialNatureCubeTilePlacement", function () {
        if ($(".mapTileContainer.potentialNatureCubeTilePlacement .tileContainer").length) {
                // add the class mapPreviewTileContainer to the currently cloned tile container in the map hex to be able to differentiate between the tile container that's going to be moved from the displayed are for the purposes of fading and removing the preview version
                $(".mapTileContainer.potentialNatureCubeTilePlacement .tileContainer").addClass(
        ...
        // adding the 'lockedIn' class allows differentiation between all of the other tile html in map div once the tile html is animated and transferred into the map
        // this class will be removed once the tile is finalized
        $(".tokenTileContainer.potentialNatureCube.natureCubeTile .tileContainer.chosenNatureCubeTile").addClass(
                "lockedIn",
        );
...
$(document).on(
        ...
        function () {
                ...
                if (
                        ...
                        $(
                                ".tokenTileContainer.potentialNatureCube.natureCubeToken .tokenContainer.chosenNatureCubeToken",
                        ).append('<img class="token" src="img/tokens/' + previouslyChosenToken + '.png" />');
                ...
                $(
                        ".tokenTileContainer.potentialNatureCube.natureCubeToken .tokenContainer.chosenNatureCubeToken",
                ).append('<img class="activeToken" src="img/tokens/' + currentChosenWildlife + 'Active.png" />');
        ...
        function () {
                ...
                if (
                        ...
                        $(".tokenTileContainer.natureCubeClearTokens .tokenContainer.currentTokenAnimation").append(
                                '<img class="activeToken" src="img/tokens/' + currentWildlifeToken + 'Active.png" />',
                        );
                        $(
                        ...
                        $(".tokenTileContainer.natureCubeClearTokens .tokenContainer.currentTokenAnimation").append(
                                '<img class="token" src="img/tokens/' + currentWildlifeToken + '.png" />',
                        );
                        $(
                                ".tokenTileContainer.natureCubeClearTokens .tokenContainer.currentTokenAnimation .token",
                        ).fadeIn();
...
$(document).on("mouseenter", ".mapTileContainer.placedTile.wildlifeTokenPotential", function () {
        ...
        $(this)
                .children()
                .append('<img class="wildlifeToken" src="img/tokens/' + currentChosenWildlife + 'Active.png" />');
});
...
function confirmInvalidTokenPlacementFunction() {
        ...
        $(".tokenTileContainer.chosenTokenTileContainer .tokenContainer").append(
                '<img class="duplicateToken" src="img/tokens/' + currentChosenWildlife + 'Inactive.png" />',
        );
        $(".tokenTileContainer.chosenTokenTileContainer .tokenContainer").append(
...
function confirmInvalidNatureCubeTokenPlacementFunction() {
        ...
        ).append('<img class="duplicateToken" src="img/tokens/' + currentChosenWildlife + 'Inactive.png" />');
        $(
                ".tokenTileContainer.potentialNatureCube.natureCubeToken.chosenNatureCubeTokenParent .tokenContainer.chosenNatureCubeToken",
...
function removeSoloTilesTokens() {
        if (turnsLeft == 1) {
                ...
                for (let i = 0; i < reverseTileTokenOrder.length; i++) {
                        ...
                        if (
                                $('.tokenTileContainer[tokentilenum="' + reverseTileTokenOrder[i] + '"] .tileContainer')
                                        .length
                        ) {
...
function pickNewTilesTokens() {
        ...
        for (let j = 0; j < reverseTileTokenOrder.length; j++) {
                ...
                if (
                        $('.tokenTileContainer[tokentilenum="' + reverseTileTokenOrder[j] + '"] .tokenContainer .token')
                                .length
                ) {
        ...
        for (let k = 0; k < newTileTokenContainerPositions.length; k++) {
                ...
                var nextTokenTileHTML =
                        '<div class="tokenTileContainer" tokentilenum="' + newTileTokenContainerPositions[k] + '">';
        ...
        $('.tokenTileContainer[tokentilenum="' + leftOverTiles[0] + '"] .tileContainer').addClass(
        ...
        $('.tokenTileContainer[tokentilenum="' + leftOverTiles[1] + '"] .tileContainer').addClass(
                "movingElementOpacity",
        );
        ...
        $('.tokenTileContainer[tokentilenum="3"] .tokenContainer').attr(
                "wildlifetoken",
                $('.tokenTileContainer[tokentilenum="' + leftOverTokens[0] + '"] .tokenContainer').attr(
                        "wildlifetoken",
                ),
        );
        ...
        $('.tokenTileContainer[tokentilenum="2"] .tokenContainer').attr(
                "wildlifetoken",
                $('.tokenTileContainer[tokentilenum="' + leftOverTokens[1] + '"] .tokenContainer').attr(
                        "wildlifetoken",
                ),
        );
...
function checkDuplicateTokens() {
        ...
        if (uniqueTokens.length == 1) {
                ...
                var duplicateImgContainer =
                        '<img class="duplicateTokenExample" src="img/tokens/' + uniqueTokens[0] + 'Inactive.png" />';
                $("#allDuplicateTokensModal .modal-content .notification #duplicateImgContainer").html(
                        duplicateImgContainer,
                );
...
function removeDuplicateTokens(duplicateAmount) {
        ...
        if (duplicateAmount == 4) {
                ...
                setTimeout(function () {
                        ...
                        for (let k = 0; k < displayedTokens.length; k++) {
                                $('.tokenTileContainer[tokentilenum="' + k + '"] .tokenContainer ').append(
                                        '<img class="replacedToken" src="img/tokens/' + displayedTokens[k] + '.png" />',
                                );
                ...
                $('.tokenContainer[wildlifetoken="' + duplicatedToken + '"]').append(
                        '<img class="duplicateToken" src="img/tokens/' + duplicatedToken + 'Inactive.png" />',
                );
                $('.tokenContainer[wildlifetoken="' + duplicatedToken + '"]').append(
                        '<img class="redCross" src="img/cross.png" />',
                );
...
function removeNatureCubeChosenTokens() {
        ...
        setTimeout(function () {
                ...
                for (let p = 0; p < tokensToReplaceIndexes.length; p++) {
                        ...
                        $(
                                '.tokenTileContainer[tokentilenum="' + tokensToReplaceIndexes[p] + '"] .tokenContainer',
                        ).append(
                                '<img class="replacedToken" src="img/tokens/' +
                                        displayedTokens[tokensToReplaceIndexes[p]] +
                                        '.png" />',
...
function generateDisplayTile(thisTile) {
        ...
        displayTileHTML +=
                '" tilewildlife="' + thisTile.wildlife.length + '" tilerotation="' + thisTile.rotation + '">';
...
function activateTokenPlacement(mode) {
        if (mode == "normalToken") {
                ...
                currentChosenWildlife = $(".tokenTileContainer.chosenTokenTileContainer .tokenContainer").attr(
                        "wildlifetoken",
                );

                // the active token image (with a green border) is added into the token container. By default it is hidden
                $(".tokenTileContainer.chosenTokenTileContainer .tokenContainer").append(
                        '<img class="activeToken" src="img/tokens/' + currentChosenWildlife + 'Active.png" />',
                );
        ...
        if (!validTokenPlacements) {
                if ($(".tokenTileContainer.chosenTokenTileContainer").length) {
                        ...
                        $("#noValidPlacementModal .modal-content .notification .invalidWildlifeText").html(
                                currentChosenWildlife,
                        );
...
function updateAllSubtotals() {
        ...
        for (let i = 0; i < tables.length; i++) {
                let thisSubTotal = 0;
                $("#" + tables[i] + ' .scoreCell .scoringInput[category="' + fullCategoryName[i] + '"]').each(
                        function () {
                ...
                if (habitatMatches[currentHabitat].placedTiles > 0) {
                        if (habitatMatches[currentHabitat].tilesWithMatchedHabitats.length > 0) {
                                let linkedTiles = JSON.parse(
                                        JSON.stringify(habitatMatches[currentHabitat].tilesWithMatchedHabitats),
                                );
...
function checkValidStartingElkToken(thisID) {
        ...
        for (let i = 0; i < blankSides.length; i++) {
                ...
                let followingColumn =
                        thisColumn + linkedTileSides[lineCheckSides[i]].rowColMapping[rowColMapSet].colDif;
